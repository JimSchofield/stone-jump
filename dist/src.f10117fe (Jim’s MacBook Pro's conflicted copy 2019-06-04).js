...
exports.renderBoard = function (board, container) {
  container.innerHTML = "" + _1["default"].mapDOM(board.grid, function (row) {
    return "<div class=\"row\">\n                " + _1["default"].mapDOM(row, function (cell) {
      return "<div class=\"" + getCellClass(cell) + "\"></div>";
    }) + "\n            </div>";
  });
};
},{"../util/_":"src/util/_.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var grid = "\n10001001\n1 000001\n011 100\n000 0001\n11  0011\n";
var gameBoard = new board_1["default"](grid);
render_1.renderBoard(gameBoard, document.querySelector('.board'));
},{"./styles/main.scss":"src/styles/main.scss","./models/board":"src/models/board.ts","./render/render":"src/render/render.ts"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
